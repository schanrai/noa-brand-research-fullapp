    ...
    <div className="flex min-h-screen flex-col">
      ...
      <div className="flex flex-1 flex-col bg-background">
        <div className="container mx-auto max-w-4xl px-4 py-12">
          <h1 className="mb-8 text-2xl font-bold tracking-tight">Terms of Service</h1>
          ...
          <div className="prose max-w-none space-y-8 text-sm">
            ...
            <section>
              <h2 className="text-lg font-semibold mb-4">2. Description of Services</h2>
              <p className="mb-4">
            ...
            <section>
              <h2 className="text-lg font-semibold mb-4">3. User Accounts and Registration</h2>
            ...
            <section>
              <h2 className="text-lg font-semibold mb-4">4. User Responsibilities</h2>
            ...
            <section>
              <h2 className="text-lg font-semibold mb-4">6. Intellectual Property Rights</h2>
              <p className="mb-4">
            ...
            <section>
              <h2 className="text-lg font-semibold mb-4">7. Data and Content</h2>
              <p className="mb-4">
            ...
            <section>
              <h2 className="text-lg font-semibold mb-4">8. Service Availability and Modifications</h2>
              <p>
            ...
            <section>
              <h2 className="text-lg font-semibold mb-4">9. Third-Party Services and Integrations</h2>
              <p className="mb-4">
            ...
            <section>
              <h2 className="text-lg font-semibold mb-4">11. Limitation of Liability</h2>
              <p className="mb-4">
            ...
            <section>
              <h2 className="text-lg font-semibold mb-4">12. Indemnification</h2>
              <p>
            ...
            <section>
              <h2 className="text-lg font-semibold mb-4">13. Termination</h2>
            ...
            <section>
              <h2 className="text-lg font-semibold mb-4">14. Force Majeure</h2>
              <p>
            ...
            <section>
              <h2 className="text-lg font-semibold mb-4">15. Governing Law and Dispute Resolution</h2>
              <p className="mb-4">
            ...
            <section>
              <h2 className="text-lg font-semibold mb-4">17. Severability</h2>
              <p>
            ...
            <section>
              <h2 className="text-lg font-semibold mb-4">18. Entire Agreement</h2>
              <p>
            ...
            <section>
              <h2 className="text-lg font-semibold mb-4">19. Contact Information</h2>
              <p className="mb-4">
